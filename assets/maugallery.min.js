  ...
  (t.fn.mauGallery = function (a) {
    ...
    (t.fn.mauGallery.listeners = function (a) {
      t(".gallery-item").on("click", function () {
        ...
        t(".gallery").on("click", ".mg-prev", () =>
          t.fn.mauGallery.methods.prevImage(a.lightboxId)
        ),
        t(".gallery").on("click", ".mg-next", () =>
    ...
    (t.fn.mauGallery.methods = {
      ...
      prevImage() {
        ...
        "all" === e
          ? t(".item-column").each(function () {
              t(this).children("img").length && l.push(t(this).children("img"));
            })
          : t(".item-column").each(function () {
              t(this).children("img").data("gallery-tag") === e &&
                l.push(t(this).children("img"));
            });
        let i = 0,
          s = null;
        t(l).each(function (e) {
          t(a).attr("src") === t(this).attr("src") && (i = e - 1);
        }),
          (s = l[i] || l[l.length - 1]),
          t(".lightboxImage").attr("src", t(s).attr("src"));
      },
      nextImage() {
        let a = null;
        t("img.gallery-item").each(function () {
      ...
      showItemTags(a, e, l) {
        ...
        let n = document.querySelectorAll(".nav-link"),
          o = null;
        n.forEach((t) => {
          (t.style.cursor = "pointer"),
            t.addEventListener("click", () => {
              o && ((o.style.background = ""), (o.style.color = "")),
                (t.style.background = "#beb45a"),
                (o = t);
            });
        });
      },
