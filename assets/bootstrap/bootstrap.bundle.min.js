...
(function (global, factory) {
  ...
  class Dropdown extends BaseComponent {
    ...
    _createPopper(parent) {
      ...
      const isDisplayStatic = popperConfig.modifiers.find(
        (modifier) => modifier.name === "applyStyles" && modifier.enabled === !1
      );
  ...
  class Tooltip extends BaseComponent {
    ...
    _getConfig(config) {
      ...
      config.container =
        config.container === !1 ? document.body : getElement(config.container);
  ...
  class Toast extends BaseComponent {
    ...
    _setListeners() {
      EventHandler.on(this._element, EVENT_MOUSEOVER, (event) =>
        this._onInteraction(event, !0)
      );
      EventHandler.on(this._element, EVENT_MOUSEOUT, (event) =>
        this._onInteraction(event, !1)
      );
